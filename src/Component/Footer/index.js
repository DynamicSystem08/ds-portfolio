...
function Footer() {
    return <div className='backgroung_img'>
        <Grid container className='footer_main'>
            <Grid item lg={2.5} className="footer_1">
            ...
            <Grid item lg={2} className="fooeter_service">
                <h3>IT SERVICES</h3>
            ...
            <Grid item lg={2.5} className="fooeter_service">
        ...
        <Grid container>
            <Grid item lg={12} className="footer_bottom">
