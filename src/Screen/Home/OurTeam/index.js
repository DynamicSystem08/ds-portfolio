    ...
    return <div className='out_team_main'>
        <Container>
            <div className='our_team_heading'>
                ...
                <h3 data-aos="fade-up" style={{ transition: "1.3s",fontFamily:'Times New Roman, Times, serif' }} id="experience_it">EXPERIENCE IT Solutions</h3>
            </div>
        </Container>
        <Grid container className='profile_cards'>
            ...
            <Grid item lg={3} md={3} sm={3} xs={11.5} className='box'>
                <div className='box_img'>
                    <img src={usman} alt="" style={{height:'400px'}} />
                </div>
                <div className="box_content">
