        ...
        <Grid container >
            ...
            <Grid item lg={4.5} md={5.5} sm={5.5} xs={12} className="location_img" data-aos="fade-down-right" style={{transition:"1.5s"}}>
                <Grid container>
                    ...
                    <Grid item lg={11} className="location_text1">
                        <p>Our Location</p>
                    ...
                    <Grid item lg={11} className="Email_text">
                        <p >Email Address</p>
                    ...
                    <Grid item lg={11} className="contact_text">
                        <p >Call Us Free</p>
                        <i style={{ marginLeft: "18%", color: "white", fontSize: "15px" }}>0317-2451901</i>
                    </Grid>
                    <Grid item lg={1}></Grid>
                    <Grid item lg={9} className="input_filed">
            ...
            <Grid item lg={1}></Grid>
            <Grid item lg={6} md={6} sm={6} xs={12} className="location_text">
                <p>GET IN TOUCH</p>
                <h3>Are you Ready for a Better, more <br></br>Productive Business?</h3>
                ...
                <Grid item lg={12} style={{ marginTop: "20px", paddingLeft: "5px" }}>
                ...
                <Grid item lg={12} style={{ marginTop: "20px", marginBottom: "70px", paddingLeft: "5px" }}>
                ...
                <Grid item lg={12}>
                    <Button variant="contained" style={{ backgroundColor: "#0554f2", width: "97%", marginTop: "-70px" }}>Message </Button>
