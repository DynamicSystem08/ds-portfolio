        ...
        <Container>
            <Grid container style={{ justifyContent: "center" }}>
                ...
                <Grid item lg={5.5} md={5.5} sm={10} className="background_aboutCompany"  >
                    <Container>
                        <Grid container>
                            <Grid item lg={10} md={9.5} sm={8} xs={12} className="up_and_down_img" id="year_h1" style={{ marginTop: "70%", marginLeft: "30px" }}>
                                <h1> 5 | year Experience IN IT </h1>
                            </Grid>
                        </Grid>
                    </Container>
                </Grid>
